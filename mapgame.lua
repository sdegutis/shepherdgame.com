...
objects.ground1.shape = love.physics.newRectangleShape(650, 5)
...
objects.ground2.shape = love.physics.newRectangleShape(650, 5)
...
objects.ground3.shape = love.physics.newRectangleShape(5, 650)
...
objects.ground4.shape = love.physics.newRectangleShape(5, 650)
...
function love.draw()
  ...
  for _, tile in pairs(objects.tiles) do
    tile.spr:draw(tile.body:getX(), tile.body:getY(), scaletile, tile.body:getAngle(), 0)
  end
end
